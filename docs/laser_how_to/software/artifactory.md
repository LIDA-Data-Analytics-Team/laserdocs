...
For Miniconda, you will need to create new environment to install packages.
...
```
Please replace testenve with the name you desire to use for your new environment
