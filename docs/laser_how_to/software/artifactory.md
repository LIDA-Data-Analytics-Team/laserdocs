...
For Miniconda, you will need to create new environment to install packages.  We recommend creating the new enviroment within the shared project Drive (N Drive)
...
```
Please replace <name_of_your_env> with the name you desire to use for your new environment
