...
The budget alert emails will be sent to the principal investigator of the research project and anyone else they have nominated to receive the emails.

## Contents of the email
Below is an example of the content of a budget alert email, which tells researchers they have spent 90% (£88.60/£98.44) of the monthly budget for a VRE named “p0500v01”.  <span style="background-color: #fff3cd;">At the time the email was sent they had actually spent £90.12. <!-- Consider: "at that time, they had actually spent £90.12." for clarity. --></span>
...
- you want budget alert emails to be sent to someone other than the principal investigator of the research project.
- you want the percentage accrued cost at which the emails are sent to be changed.
